...
const LoginPage = ({ showLogin, hideLogin }) => {
    ...
    return (
        <Modal show={showLogin} onHide={() => { hideLogin(); setloginError(false); setRegisterError(false); }}>
            ...
            <Modal.Body>
                ...
                {isLoginForm ? (
                        ...
                        {({ values, errors, touched, handleChange, handleBlur, handleSubmit }) => (
                            ...
                            <Form onSubmit={handleSubmit} className="myform model-style">
                                <div className="text-center">
                                    {loginError === "invalid" ? <FaLock size={25} className="lock-invalid" /> : loginError === "login" ? <FaLockOpen size={25} className='lock-success' /> : <FaLock size={25} />}
                                ...
                                <p className="text-center">Don't have an account? <span className="link-primary link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" style={{ cursor: "pointer" }} onClick={toggleForm}>Sign up here</span></p>
                            </Form>
                        )}
                    </Formik>
                ) : (
                    ...
                    >
                        {({ handleSubmit }) => (
                            <Form onSubmit={handleSubmit} className="myform model-style">
                                {registerError && <div className="errorBlock">{registerErrMsg}</div>}
                                ...
                                <p className="text-center mt-2">Already have an account? <span className="link-primary link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" style={{ cursor: "pointer" }} onClick={toggleForm}>Sign in here</span></p>
                            </Form>
