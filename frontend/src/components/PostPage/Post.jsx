  ...
  return <>
    ...
    <div className="container mt-3">
      ...
      <div className="row  justify-content-center">
        <div className="col-md-7 mt-3">{data.map((post) => (
          ...
          <div key={post.id}>
            ...
            <div style={{ width: '100%', maxWidth: '100%', textAlign: 'center' }}>
              ...
              <div style={{ width: '100%', maxWidth: '100%', textAlign: 'justify' }} dangerouslySetInnerHTML={{__html:DOMPurify.sanitize(post.content)}}>
